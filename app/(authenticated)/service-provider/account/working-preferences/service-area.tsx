...
const schema = yup.object().shape({
  address: yup
    ...
    .shape({
      ...
      countryCode: yup.string().required("Valid address is required"),
    })
  ...
  useEffect(() => {
    if (serviceProviderProfile?.workingPreferences?.serviceArea) {
      ...
      methods.setValue("address", {
        ...
        latitude: existingData.coordinates.latitude,
        longitude: existingData.coordinates.longitude,
  ...
  const handleSubmit = async (data: FormData) => {
    try {
      await updateServiceArea({
        ...
        radius: data.radius,
        geohash: "", // This will be generated by the Cloud Function
      });
